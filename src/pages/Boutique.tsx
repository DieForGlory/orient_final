  ...
  return <div className="w-full bg-white">
      ...
      <section className="relative bg-black text-white py-16 sm:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-none mb-6 sm:mb-8">
            БУТИК
            <br />
            ORIENT
          </h1>
          ...
          <p className="text-base sm:text-lg lg:text-xl font-normal text-white/70 max-w-2xl leading-relaxed">
            Откройте для себя мир японского часового мастерства в нашем
            эксклюзивном бутике. Персональная консультация, примерка и
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {GALLERY_IMAGES.map((image, index) => <div key={index} className="relative aspect-[4/3] overflow-hidden group">
                <img src={image} alt={`Бутик Orient ${index + 1}`} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105" />
              </div>)}
          </div>
        </div>
      </section>
