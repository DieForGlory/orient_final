  ...
  return <div className={`group ${staggerClass}`}>
      <Link to={`/product/${id}`} className="block">
        ...
        <div className="relative aspect-[4/5] bg-white mb-4 sm:mb-6 overflow-hidden">
          ...
          {/* Quick Actions - Bottom, appears on hover */}
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-500">
            ...
            e.preventDefault();
            // Add to cart logic
          }} className="w-full bg-white text-black py-2 sm:py-3 px-4 sm:px-6 text-xs sm:text-sm tracking-[0.15em] font-medium hover:bg-[#C8102E] hover:text-white transition-all duration-300 flex items-center justify-center space-x-2">
              <ShoppingBagIcon className="w-3 h-3 sm:w-4 sm:h-4" strokeWidth={2} />
